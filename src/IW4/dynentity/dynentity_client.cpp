...
static void DynEntCl_LinkModel(unsigned int dynEntId)
{
...
static void DynEntCl_LinkBrush(unsigned int dynEntId)
{
...
void DynEntCl_UnlinkEntity(unsigned int dynEntId, enum DynEntityDrawType drawType)
{
...
static void DynEntCl_SphereEntities_r(enum DynEntityDrawType drawType, unsigned int sectorIndex, struct DynEntityAreaParms* areaParms)
{
...
static void DynEntCl_CylinderEntities_r(enum DynEntityDrawType drawType, unsigned int sectorIndex, struct DynEntityAreaParms* areaParms)
{
...
unsigned int DynEntCl_SphereEntities(enum DynEntityDrawType drawType, const float* origin, float radius, int contentMask, unsigned int dynEntMaxCount, unsigned short* dynEntList)
{
...
unsigned int DynEntCl_CylinderEntities(enum DynEntityDrawType drawType, const float* origin, float radius, int contentMask, unsigned int dynEntMaxCount, unsigned short* dynEntList)
{
...
static void DynEntCl_PlayImpactEffects(int localClientNum, int sourceEntityNum, int surfaceFlags, const float* hitPos, const float* hitNormal)
{
...
static void DynEntCl_Damage(int localClientNum, unsigned int dynEntId, enum DynEntityDrawType drawType, const float* hitPos, const float* hitDir, int damage)
{
...
static unsigned int DynEntCl_GetClosestEntities(enum DynEntityDrawType drawType, const float* origin, float radius, unsigned short* hitEnts, bool isCylinder, int isBullet)
{
...
void DynEntCl_ExplosionEvent(int localClientNum, bool isCylinder, const float* origin, float innerRadius, float outerRadius, const float* impulse, float forceScale, int innerDamage, int outerDamage, int isBullet)
{
...
void DynEntCl_DestroyEvent(int localClientNum, unsigned int dynEntId, enum DynEntityDrawType drawType, const float* hitPos, const float* hitDir)
{
