...
static void XAStream_Release(const int index)
{
...
static unsigned long XA_GetSampleIndexFromMsec(const int msec, const int sampleRate)
{
...
static void XA_CalcAndAlignDesiredSampleIndex(const struct XAUDIOSOURCEFORMAT* format, const int startMsec, const int totalMsec, int* desiredSampleIndex)
{
...
static struct PktCacheEntry* XA_GetNewStreamPacket(struct XaStreamReadInfo* streamReadInfo, int offset, int packetLen)
{
...
static void XA_SetStreamPacket(struct XaStreamReadInfo* streamReadInfo, int offset, unsigned char* buf, int bufLen)
{
...
static void XA_SetStreamPacketPosition(struct IXAudioSourceVoice* sourceVoice, struct XaStreamReadInfo* streamReadInfo, struct XAUDIOPACKET* packet)
{
...
static void XA_SubmitStreamPackets(struct IXAudioSourceVoice* sourceVoice, struct XaStreamReadInfo* streamReadInfo)
{
...
static bool XA_StreamSoundFileDataOffset(struct XaStreamReadInfo* streamReadInfo, unsigned char* buffer)
{
...
void SND_ExecuteStreamRead(int streamIndex)
{
...
static bool XA_AnyEqEnabled(int entchannel, int sndEntUseEq)
{
...
static void XA_VoiceDirty(int index)
{
...
static struct IXAudioSourceVoice* XA_GetNewSourceVoice(int index, struct XAUDIOSOURCEFORMAT* format)
{
...
static void SND_StopChannel(int index)
{
...
static void SND_PauseChannel(int index)
{
...
static void SND_UnpauseChannel(int index, int timeshift)
{
...
static void SND_UpdateChannelReverb(int index)
{
...
static void SND_UpdateStreamSourceChannel(int i, int frametime)
{
