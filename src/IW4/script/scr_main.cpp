...
static void SL_BeginLoadScripts()
{
...
void Scr_ShutdownProgramHunkUser()
{
...
void Scr_BeginLoadScriptsRemote()
{
...
unsigned int Scr_LoadScriptInternal(const char* filename, struct PrecacheEntry* entries, int entriesCount)
{
...
void Scr_PrecacheAnimTrees(function * Alloc, int user)
{
