...
char* Scr_FindBreakpointInfo(const char* codePos)
{
...
static void Scr_SetTempBreakpoint(const char* codePos, unsigned int threadId, int isReturnPos)
{
...
static void Scr_RemoveNextBreakpoint()
{
...
void Scr_RestartDebuggerRemote()
{
...
bool Scr_SaveKillPos(char** killThreadCodePos)
{
...
void Scr_RestoreKillPos(bool kill_thread, char* killThreadCodePos)
{
...
static void Scr_SendKeepAliveIfNeeded()
{
