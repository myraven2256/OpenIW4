...
static void Scr_MaxScriptVariablesError()
{
...
const char* Scr_GetNextCodepos(struct VariableValue* top, const char* pos, int opcode, int mode, unsigned int* localId, int* isReturnPos)
{
...
static unsigned int Scr_GetWaittillThreadStackParentId(unsigned int localId, unsigned int startLocalId)
{
...
void VM_Endon(unsigned int selfId, unsigned int localId, unsigned int stringValue)
{
...
static void Scr_NotifyId(int id, unsigned int stringValue, unsigned int paramcount)
{
...
void Scr_NotifyLevel(unsigned int stringValue, unsigned int paramcount)
{
...
void Scr_ShutdownSystem(unsigned char sys)
{
...
struct VariableValue* Scr_GetVariable(unsigned int index)
{
...
int Scr_GetObjectArray(unsigned int arrayObjectId, unsigned int bufferSize, unsigned int* buffer, unsigned int* failureIndex, unsigned int* failureType)
{
...
int Scr_GetObjectOrigin(unsigned int objectId, float* origin)
{
...
int Scr_GetEntityArray(unsigned int arrayObjectId, unsigned int bufferSize, unsigned int* buffer, unsigned int* count, unsigned int* failureIndex, unsigned int* failureType)
{
...
const char* Scr_GetNameForType(unsigned int type)
{
...
void Scr_AddValue(struct VariableValue* value)
{
