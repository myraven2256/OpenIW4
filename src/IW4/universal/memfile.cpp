...
static void SegmentSentinelWrite(struct MemoryFile* memFile, int index)
{
...
static void SegmentSentinelReadAndVerify(struct MemoryFile* memFile)
{
...
static void MemFile_ResetSaveStrings()
{
...
static const unsigned char* MemFile_GetSegmentAddress(struct MemoryFile* memFile, int index)
{
