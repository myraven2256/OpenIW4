...
static void FS_BuildOSPathForThread(const char* base, const char* game, const char* qpath, char* ospath)
{
...
static int FS_FOpenFileReadForThread(const char* filename, void** file)
{
...
unsigned long DemoWriteThread(void* lpParameter)
{
...
int FS_WriteToDemo(const void* buffer, int len, void* h)
{
...
void FS_FinishAsyncronousDemoWrites(void* h)
{
...
bool Com_IsAddonMap(const char* mapName)
{
...
const char* Com_GetBaseMapName(const char* mapName)
{
