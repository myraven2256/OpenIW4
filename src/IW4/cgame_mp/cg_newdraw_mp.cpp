...
float CG_FadeHudMenu(int localClientNum, const struct dvar_t* fadeDvar, int displayStartTime, int duration)
{
...
float CG_GetHUDAlphaAmmo(int localClientNum)
{
...
float CG_GetHUDAlphaWeaponName(int localClientNum)
{
...
float CG_GetHUDAlphaStance(int localClientNum)
{
...
bool CG_CheckPlayerForLowClipSpecific(const struct cg_s* cgameGlob, int weapIndex, enum PlayerHandIndex hand)
{
...
bool CG_CheckPlayerForLowClip(const struct cg_s* cgameGlob, enum PlayerHandIndex hand)
{
...
static void CG_DrawPlayerWeaponNameNoFade(int localClientNum, const struct rectDef_s* rect, struct Font_s* font, float scale, float* color, int textStyle)
{
...
static void CG_DrawPlayerWeaponNameBackNoFade(int localClientNum, const struct rectDef_s* rect, struct Font_s* font, float scale, const float* color, struct Material* material)
{
...
static void CG_DrawPlayerWeaponNameFade(int localClientNum, const struct rectDef_s* rect, struct Font_s* font, float scale, float* color, int textStyle)
{
...
static void CG_DrawPlayerWeaponNameBackFade(int localClientNum, const struct rectDef_s* rect, struct Font_s* font, float scale, const float* color, struct Material* material)
{
...
static bool CG_BloodOverlayIsVisible(int localClientNum)
{
...
static void CG_BloodOverlayUpdate(struct cg_s* cgameGlob, float healthRatio)
{
...
static void CG_BloodOverlayDraw(int localClientNum, const struct rectDef_s* rect, struct Material* material, float* color)
{
...
void CG_BloodOverlayReset(struct cg_s* cgameGlob)
{
...
struct Material* CG_MaterialHandleForIndex(int localClientNum, int materialIndex)
{
...
static void CG_UpdateCursorHints(int localClientNum)
{
...
void CG_DrawSpectatorControls(int localClientNum, const struct rectDef_s* rect, struct Font_s* font, float fontScale, float* color, int textStyle, int textAlignMode)
{
...
void CG_DrawSpectatorFollowing(int localClientNum, const struct rectDef_s* rect, struct Font_s* font, float fontScale, float* color, int textStyle, int textAlignMode)
{
...
void CG_OwnerDraw(int localClientNum, struct rectDef_s parentRect, float x, float y, float w, float h, int horzAlign, int vertAlign, float text_x, float text_y, int ownerDraw, int ownerDrawFlags, float special, struct Font_s* font, float scale, float* color, struct Material* material, int textStyle, int textAlignMode)
{
