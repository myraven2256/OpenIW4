...
static void ODE_GeomFree(struct dxGeom* g, struct dxWorld* world)
{
...
int dGeomGetClass(const struct dxGeom* g)
{
...
void ODE_GeomGetAAContainedBox(struct dxGeom* geom, struct Bounds* bounds)
{
...
void ODE_GeomGetAAContainedBoxInternal(struct dxGeom* geom, struct Bounds* bounds)
{
...
void* ODE_GeomGetClassData(struct dxGeom* g)
{
...
void ODE_GeomCustomInit(struct dxGeom* const geom, int classnum, struct dxSpace* space, struct dxBody* body)
{
...
int ODE_GeomGetFlags(struct dxGeom* geom)
{
