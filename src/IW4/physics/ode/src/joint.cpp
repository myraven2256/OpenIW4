...
static void setBall(const struct dxJoint* joint, struct dxJoint::Info2* info, const float* anchor1, const float* anchor2)
{
...
static void setFixedOrientation(const struct dxJoint* joint, struct dxJoint::Info2* info, const float* qrel, int start_row)
{
...
public int dxJointLimitMotor::addLimot(const struct dxJoint* joint, struct dxJoint::Info2* info, int row, const float* ax1, int rotational)
{
...
static void ballGetInfo2(const struct dxJointBall* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
...
static void hingeGetInfo2(const struct dxJointHinge* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
...
static void ODE_OrientationGetInfo1(const struct JointOrientation* joint, struct dxJoint::Info1* info)
{
...
static void ODE_OrientationGetInfo2(const struct JointOrientation* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
...
static void ODE_PathConstraintGetInfo1(const struct JointPath* joint, struct dxJoint::Info1* info)
{
...
static void ODE_PathConstraintGetInfo2(const struct JointPath* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
...
static void sliderGetInfo2(const struct dxJointSlider* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
...
static void dumpJointInfo2(const struct dxJointContact* j, struct dxJoint::Info2* info)
{
...
static void ContactGetInfo2(const struct dxJointContact* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
...
static void universalGetInfo2(const struct dxJointUniversal* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
...
static void amotorGetInfo2(const struct dxJointAMotor* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
...
static void fixedGetInfo2(const struct dxJointFixed* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
...
static void nullGetInfo2(const struct dxJointNull* __formal, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* __formal)
{
...
void jointGetInfo2(const struct dxJoint* joint, const struct dxWorldStepInfo* stepInfo, struct dxJoint::Info2* info)
{
