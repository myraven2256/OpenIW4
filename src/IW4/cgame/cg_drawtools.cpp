...
void CG_DrawRotatedPicWithoutSplitScreenScaling(const struct ScreenPlacement* scrPlace, float x, float y, float width, float height, int horzAlign, int vertAlign, float angle, const float* color, struct Material* material)
{
...
void CG_ThermalBodyMaterialChanged(int localClientNum)
{
...
void CG_DebugBox(const float* origin, const struct Bounds* bounds, float yaw, const float* color, int depthTest, int duration)
{
...
void CG_DebugBoxOriented(const float* origin, const struct Bounds* bounds, float* rotation[0x3], const float* color, int depthTest, int duration)
{
...
bool CG_WorldDirToScreenPosReal(int localClientNum, const struct ScreenPlacement* scrPlace, const float* worldDir, float* outScreenPos)
{
...
bool CG_WorldPosToScreenPosReal(int localClientNum, const struct ScreenPlacement* scrPlace, const float* worldPos, float* outScreenPos)
{
...
bool CG_WorldDirToScreenPosVirtualCentered(int localClientNum, const float* worldDir, float* outScreenPos)
{
...
void CG_TeamColor(const int team, const char* prefix, float* color)
{
...
void CG_RelativeTeamColor(const int localClientNum, const int clientNum, const char* prefix, float* color)
{
