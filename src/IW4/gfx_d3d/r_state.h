...
void R_SetObjectPlacement(struct GfxCmdBufSourceState* source, const struct GfxPlacement* placement)
{
...
void R_SetObjectScaledPlacementRemote(struct GfxCmdBufSourceState* source, const struct GfxScaledPlacement* remotePlacement, const struct GfxScaledPlacement* placement)
{
...
void R_SetObjectScaledPlacement(struct GfxCmdBufSourceState* source, const struct GfxScaledPlacement* placement)
{
...
void R_SetObjectScaledPlacementAlternateRemote(struct GfxCmdBufSourceState* source, unsigned int worldMatrixAlternateIndex, const struct GfxScaledPlacement* remotePlacement, const struct GfxScaledPlacement* placement)
{
...
void R_ClearObjectPlacementAllAlternates(struct GfxCmdBufSourceState* source)
{
...
void R_UpdateShadowLookupMatrix(struct GfxCmdBufSourceState* source, unsigned int sceneLightIndex, const struct GfxMatrix* lookupMatrix)
{
