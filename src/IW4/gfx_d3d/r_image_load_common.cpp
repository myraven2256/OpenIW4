...
unsigned int Image_MipLevelBaseAddress(const struct GfxImage* image, struct D3DBaseTexture* basemap, enum _D3DFORMAT format, enum _D3DCUBEMAP_FACES face, unsigned int mipLevel)
{
...
static void Image_Alloc1DPixels_Xbox(struct GfxImage* image, int mipmapCount, enum _D3DFORMAT imageFormat)
{
