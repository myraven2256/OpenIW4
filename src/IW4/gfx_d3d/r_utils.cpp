...
bool R_CullPointAndRadius(const float* pt, float radius, const struct DpvsPlane* clipPlanes, unsigned int clipPlaneCount)
{
...
int R_PickMaterial(bool locationalTrace, int traceMask, const float* org, const float* dir, char* name, char* surfaceFlags, char* contents, int charLimit)
{
