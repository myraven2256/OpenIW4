...
void DevGui_AddDvar(const char* path, const struct dvar_t* dvar)
{
...
static void DevGui_DrawDvarValue(int x, int y, const struct dvar_t* dvar)
{
...
static int DevGui_DvarRowCount(const struct dvar_t* dvar)
{
...
static void DevGui_Vec3ToHSV(const float* rgb, float* hsv, float scale)
{
...
static void DevGui_Vec3FromHSV(float* rgb, const float* hsv, float scale)
{
...
static void DevGui_DrawFloat3ColorSliders(int* x, int* y, const struct dvar_t* dvar, int rowWidth, int rowHeight)
{
...
static const struct dvar_t* DevGui_SelectedDvar()
{
