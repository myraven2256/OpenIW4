...
struct XAnimTree_s* XAnimCreateSimpleTree(const char* name)
{
...
void XAnimFreeSimpleTree(struct XAnimTree_s* tree)
{
...
void XAnimPlaySimpleTreeAnim(struct DObj* obj, float animTime)
{
...
static void XAnimCalcRelDeltaParts(const struct XAnimParts* parts, const float weightScale, const float time1, const float time2, struct XAnimRotPos* rotPos, int quatIndex)
{
...
static void XAnimCalcAbsDeltaParts(const struct XAnimParts* parts, const float weightScale, const float time, struct XAnimRotPos* rotPos)
{
...
static float XAnimGetNextServerNotifyFrac(const struct DObj* obj, struct XAnimInfo* info, const struct XAnimState* syncState, const struct XAnimState* nextSyncState, float dtime)
{
...
static void XAnimUpdateInfoSync(const struct DObj* obj, unsigned int infoIndex, bool bNotify, struct XAnimState* syncState, float dtime)
{
...
static void XAnimUpdateTimeAndNotetrackLeaf(const struct DObj* obj, const struct XAnimParts* parts, unsigned int infoIndex, float dtime, bool bNotify)
{
...
static void XAnimUpdateTimeAndNotetrackSyncSubTree(const struct DObj* obj, unsigned int infoIndex, float dtime, bool bNotify)
{
...
static void XAnimUpdateTimeAndNotetrack(const struct DObj* obj, unsigned int infoIndex, float dtime, bool bNotify)
{
...
static void XAnimUpdateOldTime(struct DObj* obj, unsigned int infoIndex, struct XAnimState* syncState, float dtime, bool parentHasWeight, bool* childHasTimeForParent)
{
...
static void NotifyServerNotetrack(const struct DObj* obj, unsigned int notifyName, unsigned int notetrackName)
{
...
static float XAnimGetServerNotifyFracSyncTotal(const struct DObj* obj, struct XAnimInfo* info, const struct XAnimState* syncState, const struct XAnimState* nextSyncState, float dtime)
{
...
static float XAnimFindServerNoteTrackLeafNode(const struct DObj* obj, struct XAnimInfo* info, float dtime)
{
...
static float XAnimFindServerNoteTrackSyncSubTree(const struct DObj* obj, struct XAnimInfo* info, float dtime)
{
...
static float XAnimFindServerNoteTrack(const struct DObj* obj, unsigned int infoIndex, float dtime)
{
...
static void XAnimProcessServerNotify(const struct DObj* obj, struct XAnimInfo* info, float time)
{
...
void XAnimResetAnimMap(const struct DObj* obj, unsigned int infoIndex)
{
...
static void XAnimCalcDeltaTree(const struct DObj* obj, const unsigned int infoIndex, const float weightScale, const struct XAnimDeltaInfo deltaInfo, struct XAnimRotPos* rotPos)
{
...
static int XAnimIsDefault(struct XAnimParts* animParts)
{
...
void DObjInitServerTime(struct DObj* obj, float dtime)
{
...
void DObjUpdateClientInfo(struct DObj* obj, float dtime, bool notify)
{
...
int DObjUpdateServerInfo(struct DObj* obj, float dtime, int bNotify)
{
...
void DObjDisplayAnimToBuffer(const struct DObj* obj, const char* header, char* buffer, int bufferSize)
{
...
void DObjDisplayAnim(const struct DObj* obj, const char* header)
{
...
void XAnimCalcDelta(struct DObj* obj, unsigned int animIndex, float* rot, float* trans, bool bUseGoalWeight)
{
...
void XAnimCalcAbsDelta(struct DObj* obj, unsigned int animIndex, float* rot, float* trans)
{
...
static unsigned int XAnimEnsureGoalWeightParent(struct DObj* obj, unsigned int animIndex)
{
...
static unsigned int XAnimAllocInfoIndex(struct DObj* obj, unsigned int animIndex, int after)
{
...
struct XAnimInfo* XAnimAllocInfo(struct DObj* obj, unsigned int animIndex, int after)
{
...
static int XAnimSetCompleteGoalWeightNodeRel(struct XAnimTree_s* tree, unsigned int infoIndex, unsigned int rootIndex, float goalWeight, float goalTime, float rate, unsigned int notifyName, unsigned int notifyType)
{
...
int XAnimSetCompleteGoalWeightKnob(struct DObj* obj, unsigned int animIndex, float goalWeight, float goalTime, float rate, unsigned int notifyName, int bRestart)
{
...
int XAnimSetGoalWeightKnobAll(struct DObj* obj, unsigned int animIndex, unsigned int rootIndex, float goalWeight, float goalTime, float rate, unsigned int notifyName, int bRestart)
{
...
int XAnimSetCompleteGoalWeightKnobAll(struct DObj* obj, unsigned int animIndex, unsigned int rootIndex, float goalWeight, float goalTime, float rate, unsigned int notifyName, int bRestart)
{
...
int XAnimSetGoalWeightKnob(struct DObj* obj, unsigned int animIndex, float goalWeight, float goalTime, float rate, unsigned int notifyName, int bRestart)
{
...
int XAnimSetGoalWeight(struct DObj* obj, unsigned int animIndex, float goalWeight, float goalTime, float rate, unsigned int notifyName, unsigned int notifyType, int bRestart)
{
...
int XAnimSetCompleteGoalWeight(struct DObj* obj, unsigned int animIndex, float goalWeight, float goalTime, float rate, unsigned int notifyName, unsigned int notifyType, int bRestart)
{
...
int XAnimSetCompleteGoalWeightRel(struct DObj* obj, unsigned int animIndex, unsigned int rootIndex, float goalWeight, float goalTime, float rate, unsigned int notifyName, unsigned int notifyType, int bRestart)
{
