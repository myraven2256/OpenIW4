...
void XModelGetBounds(const struct XModel* model, struct Bounds* bounds)
{
...
int XModelTraceLineAnimated(const struct DObj* obj, unsigned int modelIndex, int baseBoneIndex, struct trace_t* results, const struct DObjAnimMat* boneMtxList, const float* localStart, const float* localEnd, int contentmask)
{
...
void XModelTraceLineAnimatedPartBits(const struct DObj* obj, unsigned int modelIndex, int baseBoneIndex, int contentmask, int* partBits)
{
...
static int XModelHasParentBone(const struct XModel* model, unsigned char goalParentIndex, unsigned int childIndex)
{
...
int XModelGetNextChildBoneIndex(const struct XModel* model, unsigned char parentIndex, unsigned int offset, unsigned char* childIndex)
{
