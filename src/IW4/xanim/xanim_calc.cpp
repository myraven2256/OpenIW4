...
static void XAnimClearRotTransArray(const struct DObj* obj, struct DObjAnimMat* rotTransArray, struct XAnimCalcAnimInfo* info)
{
...
static void XAnimCalcNonLoopEnd(const struct XAnimParts* parts, const unsigned char* animToModel, float weightScale, struct DObjAnimMat* rotTransArray, const class bitarray<160>* ignorePartBits)
{
...
bool XAnimGetKeyFrame<unsigned char>(const class bitarray<160>* ignorePartBits, int modelPartIndex, int tableSize, struct XAnimTime* animTime, unsigned char** dataByte, short** dataShort, unsigned char** indices, int* keyFrameIndex, float* keyFrameLerpFrac)
{
...
bool XAnimGetKeyFrame<unsigned short>(const class bitarray<160>* ignorePartBits, int modelPartIndex, int tableSize, struct XAnimTime* animTime, unsigned char** dataByte, short** dataShort, unsigned short** indices, int* keyFrameIndex, float* keyFrameLerpFrac)
{
...
static void XAnimCalcParts<unsigned char>(const struct XAnimParts* parts, const unsigned char* animToModel, const float time, const float weightScale, struct DObjAnimMat* rotTransArray, const class bitarray<160>* ignorePartBits)
{
...
static struct DObjAnimMat* XAnimGetCalcBuffer(struct XAnimCalcAnimInfo* info, const struct DObj* obj, int* rotTransArrayIndex)
{
...
static void XAnimCalc(const struct DObj* obj, struct XAnimInfo* info, float weightScale, bool bClear, bool bNormQuat, struct XAnimCalcAnimInfo* animInfo, int rotTransArrayIndex, struct DObjAnimMat* rotTransArray)
{
...
void DObjCalcAnim(const struct DObj* obj, int* partBits, struct XAnimCalcAnimInfo* animInfo)
{
...
static void XAnim_CalcRotDelta3DDuring<unsigned char>(const struct XAnimDeltaPart* animDelta, const float time, const int frameCount, float* rotDelta)
{
...
static void XAnim_CalcRotDelta3DEntire(const struct XAnimDeltaPart* animDelta, float* rotDelta)
{
...
void XAnim_CalcDelta3DForTime(const struct XAnimParts* anim, const float time, float* rotDelta, struct __vector4& posDelta)
{
