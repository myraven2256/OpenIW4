...
static bool CM_BrushInView(unsigned int brushIndex, struct cplane_s* frustumPlanes, int frustumPlaneCount)
{
...
void CM_ShowSingleBrushCollision(const struct Bounds* bounds, const struct cbrush_t* brush, const float* color, function * drawCollisionPoly)
{
