...
bool CM_CullBox(const struct traceWork_t* tw, struct __vector4 boundsMidPoint, struct __vector4 boundsHalfSize)
{
...
static void CM_TracePointThroughTriangle(const struct traceWork_t* tw, const unsigned short* indices, const float* verts[0x3], struct trace_t* trace)
{
...
static void CM_TraceCapsuleThroughTriangle(const struct traceWork_t* tw, int triIndex, const unsigned short* indices, const float* verts[0x3], struct trace_t* trace)
{
...
static float CM_DistanceSquaredFromPointToTriangle(const float* pt, const unsigned short* indices, const float* verts[0x3])
{
...
static bool CM_DoesCapsuleIntersectTriangle(const float* start, const float* end, float radiusSq, const unsigned short* indices, const float* verts[0x3])
{
...
static void CM_PositionTestCapsuleInTriangle(const struct traceWork_t* tw, const unsigned short* indices, const float* verts[0x3], struct trace_t* trace)
{
...
static bool CM_PartitionChecked(const struct traceWork_t* tw, unsigned int partitionIndex)
{
...
static void CM_TraceThroughAabbTree_Hit(const struct traceWork_t* tw, const struct CollisionAabbTree* aabbTree, struct trace_t* trace)
{
...
static void CM_TraceThroughAabbTree_Iterate(const struct traceWork_t* tw, const struct CollisionAabbTree* aabbTree, struct trace_t* trace)
{
