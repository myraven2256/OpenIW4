...
void Netchan_Init(unsigned int port)
{
...
int NET_GetMaxFragmentLength(struct netchan_t* chan)
{
...
void Netchan_SetUpBuffers(struct netchan_t* chan, unsigned char* outgoingBuffer, int outgoingBufferSize, unsigned char* incomingBuffer, int incomingBufferSize)
{
...
void Netchan_Setup(enum netsrc_t sock, struct netchan_t* chan, struct netadr_t adr, int qport, char* outgoingBuffer, int outgoingBufferSize, char* incomingBuffer, int incomingBufferSize, int remoteClientIndex)
{
...
static int NET_GetServerLoopPacket_Real(struct netadr_t* net_from, struct msg_t* net_message)
{
...
static int NET_GetClientLoopPacket_Real(enum netsrc_t sock, struct netadr_t* net_from, struct msg_t* net_message)
{
...
static void NET_SendServerLoopPacket(int port, int length, const void* data, struct netadr_t to)
{
...
static void NET_SendClientLoopPacket(enum netsrc_t sock, int length, const void* data, struct netadr_t to)
{
...
int NET_OutOfBandVoiceData(enum netsrc_t sock, struct netadr_t adr, unsigned char* format, int len, bool voiceData)
{
