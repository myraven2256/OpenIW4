...
void FX_GetOriginForTrailElem(const struct FxElemDef* elemDef, const struct FxTrail* localTrail, const struct FxSpatialFrame* effectFrameWhenPlayed, int randomSeed, float* outOrigin, float* outRight, float* outUp)
{
...
void FX_SpatialFrameSetIdentity(struct FxSpatialFrame* frame)
{
...
void FX_SpatialFrameInvert(const struct FxSpatialFrame* in, struct FxSpatialFrame* out)
{
...
void FX_SpatialFrameMultiply(const struct FxSpatialFrame* in0, const struct FxSpatialFrame* in1, struct FxSpatialFrame* out)
{
...
void FX_AddVisBlocker(const struct FxSystem* system, const float* posWorld, float radius, float opacity)
{
