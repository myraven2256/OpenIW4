...
const struct FxElemDef* FX_GetUpdateElemDef(const struct FxUpdateElem* update)
{
...
static void FX_SpawnTrailLoopingElems(struct FxSystem* system, struct FxEffect* effect, struct FxTrail* trail, const struct FxSpatialFrame* frameBegin, const struct FxSpatialFrame* frameEnd, int msecWhenPlayed, int msecUpdateBegin, int msecUpdateEnd, float distanceTravelledBegin, float distanceTravelledEnd, float arcDistanceTravelled)
{
...
static void FX_ProcessLooping(struct FxSystem* system, struct FxEffect* effect, int elemDefFirst, int elemDefCount, const struct FxSpatialFrame* frameBegin, const struct FxSpatialFrame* frameEnd, int msecWhenPlayed, int msecUpdateBegin, int msecUpdateEnd, float distanceTravelledBegin, float distanceTravelledEnd, float arcDistanceTravelled)
{
...
static void FX_SpawnDeathEffect(struct FxSystem* system, const struct FxUpdateElem* update)
{
...
static void FX_UpdateElement_SetupUpdate(struct FxEffect* effect, int msecUpdateBegin, int msecUpdateEnd, int elemDefIndex, int elemAtRestFraction, int msecElemBegin, bool isTrail, int elemSequence, float* elemOrigin, struct FxUpdateElem* update)
{
...
static void FX_UpdateElement_UpdatePositionWithBaseVel(struct FxSystem* system, struct FxUpdateElem* update, float* elemBaseVel, enum FxUpdateResult* outUpdateResult)
{
...
static void FX_UpdateElement_RecordSparkCloud(struct FxSystem* system, struct FxUpdateElem* update, struct FxElem* elem)
{
...
static void FX_UpdateEffectPartialTrail(struct FxSystem* system, struct FxEffect* effect, struct FxTrail* trail, int msecUpdateBegin, int msecUpdateEnd, float distanceTravelledEnd, unsigned short trailElemHandleStart, unsigned short trailElemHandleStop, struct FxSpatialFrame* frameNow)
{
...
void FX_UpdateEffectPartial(struct FxSystem* system, struct FxEffect* effect, int msecUpdateBegin, int msecUpdateEnd, float distanceTravelledBegin, float distanceTravelledEnd, float arcDistanceTravelled, unsigned short* elemHandleStart, unsigned short* elemHandleStop, unsigned short* trailElemStart, unsigned short* trailElemStop)
{
...
static void FX_UpdateBoltSceneStatus(const int localClientNum, struct FxEffect* effect, int dobjHandle)
{
...
static float FX_GetArcDistanceTravelledThisFrame(struct FxEffect* effect)
{
...
static float FX_GetDistanceTravelledThisFrame(struct FxEffect* effect)
{
...
void FX_UpdateSpotLight(int localClientNum)
{
...
void FX_BeginUpdateView(int localClientNum)
{
...
void FX_SortEffects(struct FxCmd* cmd)
{
...
static void FX_RewindTo_Setup(int localClientNum, int time)
{
...
static void FX_RewindTo_Finish(int localClientNum)
{
...
void FX_SetNextUpdateCamera(int localClientNum, const struct refdef_t* refdef, const struct RefdefView* view, float zfar, bool isThermalVision)
{
