...
static void FX_InterlockedDecrement(volatile long* minuend)
{
...
bool FX_SpotLightIsAttachedToDobj(int localClientNum, const struct DObj* obj)
{
...
static struct FxBolt* FX_AllocBolt(struct FxSystem* system)
{
...
static struct FxSparkCloud* FX_AllocSparkCloud(struct FxSystem* system)
{
...
static struct FxSparkFountain* FX_AllocSparkFountain(struct FxSystem* system)
{
...
static struct FxSparkFountainCluster* FX_AllocSparkFountainCluster(struct FxSystem* system)
{
...
static void FX_InitPool_Generic<FxElem>(volatile long* firstFree, struct FxPool<FxElem>* poolArray)
{
...
static bool FX_ViewElemForSpawn(const struct FxCamera* camera, const struct FxElemDef* elemDef, const float* origin)
{
...
static void FX_RunGarbageCollection_FreeSparkFountains(struct FxSystem* system, struct FxEffect* effect)
{
...
static void FX_RunGarbageCollection_FreeBolt(struct FxSystem* system, struct FxEffect* effect)
{
...
void FX_SpawnEffect_AllocTrailsAndFountains(struct FxSystem* system, struct FxEffect* effect)
{
...
static bool FX_CanAllocBolt(const struct FxSystem* system)
{
...
void FX_CalculateLighting(const float* origin, unsigned char* lighting)
{
...
struct FxEffect* FX_SpawnEffect(struct FxSystem* system, const struct SpawnEffectInfo* info)
{
...
struct FxEffect* FX_SpawnOrientedEffectWithViewmodelInfo(int localClientNum, const struct FxEffectDef* def, int msecBegin, const float* origin, const float* axis[0x3], unsigned int markEntnum, bool markGivenModelsOnly, bool markViewmodel, int markViewmodelClientIndex)
{
...
struct FxEffect* FX_SpawnOrientedEffect(int localClientNum, const struct FxEffectDef* def, int msecBegin, const float* origin, const float* axis[0x3])
{
...
void FX_PlayOrientedEffectWithMarkEntity(int localClientNum, const struct FxEffectDef* def, int startMsec, const float* origin, const float* axis[0x3], unsigned int markEntnum, bool markGivenModelsOnly)
{
...
void FX_PlayOrientedEffectWithMarkViewmodel(int localClientNum, const struct FxEffectDef* def, int startMsec, const float* origin, const float* axis[0x3])
{
...
static struct FxEffect* FX_SpawnBoltedEffect(int localClientNum, const struct FxEffectDef* def, int msecBegin, int dobjHandle, int boneIndex)
{
...
void FX_StopBoltedEffects(int localClientNum, const struct FxEffectDef* defHandle, unsigned int dobjHandle, unsigned int boneIndex)
{
...
void FX_EffectRestartLooping(struct FxSystem* system, struct FxEffect* effect)
{
...
void FX_EffectStopLooping(struct FxSystem* system, struct FxEffect* effect)
{
...
void FX_PreventRewind(struct FxSystem* system, struct FxEffect* effect)
{
...
void FX_KillEffectDefNewerThan(int localClientNum, const struct FxEffectDef* def, int time)
{
...
void FX_SpawnElem(struct FxSystem* system, struct FxEffect* effect, int elemDefIndex, const struct FxSpatialFrame* effectFrameWhenPlayed, int msecWhenPlayed, int sequence)
{
...
struct FxGlassVisInfo* FX_GetGlassVisInfo()
{
