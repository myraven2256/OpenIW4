...
static void SV_SetSystemInfoConfig()
{
...
void SV_SpawnServer(const char* server, int mapIsPreloaded, int savegame, bool cheats)
{
...
static void FlushServerLoopbackPackets()
{
