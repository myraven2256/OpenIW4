...
static void SetupChatField(const int localClientNum, int teamChat, int widthInPixels)
{
...
static void Con_CheckResize(const struct ScreenPlacement* scrPlace)
{
...
static int ConDrawInput_GetDvarDescriptionLines(const struct dvar_t* dvar)
{
