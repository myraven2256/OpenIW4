...
static void CompleteCommand(const struct ScreenPlacement* scrPlace)
{
...
static void Key_ClearStates_Internal(int localClientNum, bool excludeTriggers)
{
...
void Key_ClearStatesExceptTriggers(int localClientNum)
{
