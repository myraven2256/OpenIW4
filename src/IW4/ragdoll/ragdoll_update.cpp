...
static struct DObjAnimMat* Ragdoll_CalcPoseForParts(const struct cpose_t* pose, struct DObj* obj, int* partBits)
{
...
static void Ragdoll_GetDObjBaseBoneMatrix(struct DObj* obj, unsigned char boneIndex, struct DObjAnimMat* outMat)
{
...
static bool Ragdoll_GetDObjBaseBoneOrigin(int localClientNum, struct DObj* obj, const float* offset, const float* axis[0x3], unsigned char boneIndex, float* origin)
{
...
static bool Ragdoll_GetDObjBaseBoneOriginQuat(int localClientNum, struct DObj* obj, const float* offset, const float* axis[0x3], unsigned char boneIndex, float* origin, float* quat)
{
...
static bool Ragdoll_SnapshotBaseLerpBones(struct RagdollBody* body, struct BoneOrientation* snapshot)
{
...
static bool Ragdoll_SnapshotBonePositions(struct RagdollBody* body, struct BoneOrientation* boneSnapshot)
{
...
static bool Ragdoll_SnapshotAnimOrientations(struct RagdollBody* body, struct BoneOrientation* snapshot)
{
...
static bool Ragdoll_CreatePhysObj(struct RagdollBody* body, struct BoneDef* boneDef, struct Bone* bone, float* boneOrigin)
{
...
static void Ragdoll_SetParentDists(struct RagdollBody* body, float* bonePositions[0x3])
{
...
static void Ragdoll_PullJointsTogether(struct RagdollBody* body)
{
...
void Ragdoll_ExplosionEvent(int localClientNum, bool isCylinder, const float* origin, float innerRadius, float outerRadius, const float* impulse, float inScale, int isBullet)
{
...
static void Ragdoll_SetInitialVelocities(struct RagdollBody* body)
{
...
static bool Ragdoll_IsBodyRootMoving(struct RagdollBody* body)
{
...
void Ragdoll_SetUpdateTime(int msec)
{
...
void Ragdoll_Update(int localClientNum)
{
...
static void Ragdoll_UpdatePreviousCentroids()
{
